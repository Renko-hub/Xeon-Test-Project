const FanInfo = (s: Record<string, string>) => (
  <ul className={s.info_container}>
    ...
    <li className={s.info_item}>
      <span className={s.info_icon}>💨</span>
      <span className={s.info_text}>
        На платах с активным охлаждением VRM их обороты настраиваются в BIOS по
    ...
    <li className={s.info_item}>
      <span className={s.info_icon}>⚙️</span>
      <span className={s.info_text}>
        Если нет реакции на настройки, убедитесь, что выбран режим «Smart Fan
        Control» или «Manual» вместо «Full Speed».
      </span>
    </li>
  </ul>
);
