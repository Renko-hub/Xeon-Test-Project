...
export const TREFI_TABLE = {
  ...
  aggressive: { V2: 32767, V3: 65535, V4: 65535 },
...
export const MEMORY_PRESETS = {
  ...
  2133: {
    ...
    balanced: { tCL: 13, tRCD: 13, tRP: 13, tRFC: 278 },
    aggressive: { tCL: 12, tRCD: 12, tRP: 12, tRFC: 260 },
  },
  2400: {
    safe: {
      tCL: 16,
    ...
    balanced: { tCL: 13, tRCD: 13, tRP: 13, tRFC: 312 },
    aggressive: { tCL: 12, tRCD: 12, tRP: 12, tRFC: 280 },
  },
};
